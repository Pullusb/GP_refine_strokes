...
updater.addon = "gp_refine_strokes"
...
def register(bl_info):
	...
	updater.repo = "GP_refine_strokes"

	#updater.addon = # define at 	top of module, MUST be done first

	# Website for manual addon download, optional but recommended to set
	updater.website = "https://github.com/Pullusb/GP_refine_strokes"
	...
	updater.version_min_update = (0,1,4)
